...
- (void)viewDidLoad {
    [super viewDidLoad];
    self.citiesArray = @[@"Name", @"Name", @"Name", @"Name", @"Name", @"Name", @"Name", @"Name", @"Name", @"Name", @"Name", @"Name", @"Name", @"Name", @"Name", @"Name", @"Name", @"Name"];
    ...
    [_headerLabel setText: [NSString stringWithFormat:@"%d Connections", [_citiesArray count]]];
}
